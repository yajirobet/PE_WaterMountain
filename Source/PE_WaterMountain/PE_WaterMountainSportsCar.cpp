...
#include "PE_WaterMountainSportsCar.h"
#include "PE_WaterMountainSportsWheelFront.h"
#include "PE_WaterMountainSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

APE_WaterMountainSportsCar::APE_WaterMountainSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UPE_WaterMountainSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UPE_WaterMountainSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UPE_WaterMountainSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UPE_WaterMountainSportsWheelRear::StaticClass();
