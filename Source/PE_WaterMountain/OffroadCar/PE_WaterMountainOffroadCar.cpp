...
#include "PE_WaterMountainOffroadCar.h"
#include "PE_WaterMountainOffroadWheelFront.h"
#include "PE_WaterMountainOffroadWheelRear.h"
...
APE_WaterMountainOffroadCar::APE_WaterMountainOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UPE_WaterMountainOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UPE_WaterMountainOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UPE_WaterMountainOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UPE_WaterMountainOffroadWheelRear::StaticClass();
